...
class Zend_Cache_Core
{
     ...
     */
    protected static array $_directivesList = ['lifetime', 'logging', 'logger'];
    ...
    protected function _validateIdOrTag($string)
    {
        ...
        // TODO Redis does not have this limitation, so we're good.
